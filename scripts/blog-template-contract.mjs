...
`,
  ...
  assert.ok(html.includes('href="https://onnellab.com/favicon.svg?v=20260713-ol-classic-v2"'));
  assert.ok(html.includes('href="https://onnellab.com/favicon-32x32.png?v=20260713-ol-classic-v2"'));
  assert.ok(html.includes('href="https://onnellab.com/apple-touch-icon.png?v=20260713-ol-classic-v2"'));
  assert.ok(html.includes('href="https://onnellab.com/site.webmanifest?v=20260713-ol-classic-v2"'));
