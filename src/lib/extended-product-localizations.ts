...
export const extendedProductCopy: Record<ExtendedSiteLocale, Record<string, ExtendedProductCopy>> = {
  'pt-BR': {
    ...
    clipnest: make('Área de transferência e textos reutilizáveis', `ClipNest é uma ferramenta local de área de transferência para iPhone e iPad.\n\nQuando o teclado ClipNest é aberto, ele verifica a área de transferência naquele momento e salva novos textos no dispositivo. Assim você pode reutilizar mensagens, endereços, e-mails, links e trechos frequentes sem procurar novamente em outros apps ou notas.\n\n## Principais recursos\n\n- Salvar o texto copiado ao abrir o teclado\n- Colar diretamente pelo teclado\n- Fixar itens usados com frequência\n- Reutilizar o histórico recente\n- Tratar entradas duplicadas\n- Armazenamento local no dispositivo\n\nClipNest não monitora a área de transferência continuamente. Os textos salvos não são enviados para servidores externos. Não há conta, anúncios nem assinatura.`, 'Perguntas frequentes', [
      { question: 'O ClipNest monitora a área de transferência o tempo todo?', answer: 'Não. Ele verifica o conteúdo atual uma vez quando o teclado é aberto.' },
      { question: 'Os textos salvos são enviados para um servidor?', answer: 'Não. Eles permanecem armazenados localmente no dispositivo.' },
      { question: 'Posso fixar textos que uso sempre?', answer: 'Sim. Itens importantes podem ser fixados para acesso rápido pelo teclado.' }
    ]),
    meriq: make("Crie adesivos e chaveiros de acrílico", "O Meriq ajuda você a preparar arquivos para imprimir adesivos, chaveiros de acrílico e photocards. Escolha as medidas recomendadas para o produto ou informe o tamanho final desejado e posicione sua arte na frente ou no verso, tudo em um só projeto.\n\n## Confira a remoção de fundo antes de aplicar\n\nNos projetos de chaveiros de acrílico transparente e adesivos com corte especial, o Meriq gera no dispositivo uma sugestão de remoção de fundo para imagens opacas que atendam aos critérios. Confira o resultado, aplique, ajuste a seleção ou mantenha a imagem original.\n\n## Prepare o corte, a tinta branca e a exportação no mesmo projeto\n\n- Escolha medidas recomendadas por produto ou defina o tamanho final\n- Posicione imagens e edite as camadas de produção da frente e do verso\n- Prepare linhas de corte vetoriais e uma camada de tinta branca sob a arte\n- Prepare e edite camadas de acabamento compatíveis; os recursos de acabamento exigem Meriq Pro\n- Confira as dimensões reais e a resolução da imagem com uma verificação básica de produção\n- Exporte PNG transparente e PDF com o conteúdo de produção combinado\n- Transfira projetos editáveis em pacotes ZIP padrão\n\n## Confira os requisitos da gráfica antes de enviar\n\nO PDF combina o conteúdo de produção e não mantém camadas de produção editáveis separadamente. Antes de enviar à gráfica, confirme os formatos de arquivo e as medidas exigidos.\n\n## Sua arte fica no seu dispositivo\n\nOs projetos e as imagens importadas ficam armazenados no dispositivo. As prévias e exportações também são processadas localmente. Não é preciso criar conta nem fazer login, e não há anúncios ou sincronização em nuvem. Você escolhe os arquivos a importar; exportar, compartilhar e transferir projetos só acontece quando você inicia essas ações. O conteúdo de imagens e projetos não é gravado em logs de diagnóstico.", "Perguntas frequentes", [{"question": "O Meriq envia projetos ou imagens para servidores?", "answer": "Não. Os projetos e as imagens importadas ficam no dispositivo, e as prévias e exportações são processadas localmente. Sua arte não é enviada aos servidores da ONNELLAB."}, {"question": "Quais formatos posso exportar?", "answer": "Você pode exportar PNG transparente e PDF com o conteúdo de produção combinado. O PDF não mantém camadas de produção editáveis separadamente. Para transferir um projeto editável, use um pacote ZIP padrão."}, {"question": "Os recursos de acabamento exigem Pro?", "answer": "Sim. Preparar e editar as camadas de acabamento compatíveis exige Meriq Pro."}, {"question": "Comprar ou restaurar uma compra envia o conteúdo do projeto?", "answer": "Não. A App Store ou o Google Play processa compras e restaurações. O conteúdo do projeto não é enviado nesse processo."}, {"question": "O compartilhamento ou a exportação acontece automaticamente?", "answer": "Não. Exportar, compartilhar e transferir um pacote ZIP de projeto só acontece quando você inicia a ação."}]),
    quivra: make('Conversor de mídia', `Quivra é um conversor de mídia de compra única que transforma WAV, M4A, MP4 e MOV seguindo regras fixas. Não há anúncios nem assinatura.\n\nAo escolher um arquivo, o app seleciona automaticamente a conversão adequada ao formato de entrada. Você não precisa configurar o formato de saída antes de começar.\n\n## Conversões disponíveis\n\n- WAV para MP3\n- M4A para MP3\n- Extrair áudio MP3 de MP4\n- MOV para vídeo MP4\n\nO local de saída escolhido é lembrado e conflitos de nome são tratados automaticamente. O arquivo original não é alterado; um novo arquivo convertido é criado.`, 'Perguntas frequentes', [
      { question: 'Preciso escolher o formato de saída?', answer: 'Não. A conversão é escolhida automaticamente conforme o formato do arquivo de entrada.' },
      { question: 'Quais conversões são suportadas?', answer: 'WAV e M4A viram MP3, MP4 pode ter o áudio extraído para MP3 e MOV é convertido em vídeo MP4.' },
      { question: 'O arquivo original é modificado?', answer: 'Não. O original permanece intacto e o resultado é salvo como um novo arquivo.' }
    ]),
    segra: make('Cortar e combinar áudio', `Segra é uma ferramenta simples para tarefas comuns com áudio. Você pode recortar partes de MP3 e WAV, combinar várias gravações e criar um vídeo MP4 a partir de áudio e imagem.\n\nO foco não é produção musical completa, e sim recortar gravações longas, juntar arquivos na ordem escolhida e preparar vídeos simples para narração, podcasts, audiolivros ou áudio TTS.\n\n## Principais recursos\n\n- Escolher ponto inicial e final para recortar\n- Combinar vários arquivos de áudio\n- Criar MP4 com áudio e imagem\n- Preservar os arquivos originais\n- Processar tudo localmente e offline\n\nNão há login, upload de arquivos, anúncios nem rastreamento.`, 'Perguntas frequentes', [
      { question: 'O arquivo de áudio original é alterado?', answer: 'Não. Recortes e combinações são salvos como novos arquivos.' },
      { question: 'Quais tarefas de áudio são suportadas?', answer: 'Recorte de MP3/WAV, combinação de arquivos e criação de MP4 com áudio e imagem.' },
      { question: 'Os arquivos são enviados para um servidor?', answer: 'Não. O processamento ocorre no dispositivo.' }
    ]),
...
- Projetos e EPUBs gerados não são enviados para servidores da ONNELLAB`, 'Perguntas frequentes', [
  ...
  de: {
    ...
    meriq: make("Sticker & Acrylanhänger gestalten", "Mit Meriq bereitest du Druckdaten für Aufkleber, Acryl-Schlüsselanhänger und Fotokarten vor. Wähle empfohlene Produktmaße oder gib eigene Endmaße ein und platziere dein Motiv auf der Vorder- oder Rückseite – alles in einem Projekt.\n\n## Hintergrundentfernung erst prüfen, dann übernehmen\n\nBei Projekten für transparente Acryl-Schlüsselanhänger und formgeschnittene Aufkleber erstellt Meriq auf deinem Gerät einen Vorschlag zur Hintergrundentfernung für geeignete Bilder ohne Transparenz. Prüfe das Ergebnis, übernimm es, passe die Auswahl an oder behalte das Original.\n\n## Schnittkontur, Weißdruck und Export in einem Projekt\n\n- Produktspezifische Maßempfehlungen nutzen oder eigene Endmaße festlegen\n- Bilder auf Vorder- und Rückseite platzieren und Produktionsebenen bearbeiten\n- Vektor-Schnittkonturen und eine weiße Druckschicht unter dem Motiv vorbereiten\n- Unterstützte Veredelungsebenen vorbereiten und bearbeiten; Veredelungsfunktionen erfordern Meriq Pro\n- Tatsächliche Abmessungen und Bildauflösung mit einer grundlegenden Produktionsprüfung kontrollieren\n- Transparente PNG-Dateien und PDF-Dateien mit zusammengeführten Produktionsinhalten exportieren\n- Bearbeitbare Projekte in Standard-ZIP-Paketen übertragen\n\n## Vor der Abgabe die Vorgaben der Druckerei prüfen\n\nDer PDF-Export führt Produktionsinhalte zusammen und enthält keine einzeln bearbeitbaren Produktionsebenen. Prüfe vor der Abgabe die Datei- und Größenvorgaben deiner Druckerei.\n\n## Deine Motive bleiben auf deinem Gerät\n\nProjekte und importierte Bilder werden lokal auf deinem Gerät gespeichert. Auch Vorschau und Export werden dort verarbeitet. Du brauchst weder ein Konto noch eine Anmeldung; Werbung und Cloud-Synchronisierung gibt es nicht. Du wählst die Dateien zum Importieren selbst aus. Export, Teilen und Projektübertragung starten nur auf deine Anweisung. Bild- und Projektinhalte werden nicht in Diagnoseprotokolle geschrieben.", "Häufige Fragen", [{"question": "Lädt Meriq Projekte oder Bilder auf einen Server hoch?", "answer": "Nein. Projekte und importierte Bilder bleiben auf deinem Gerät. Auch Vorschau und Export werden lokal verarbeitet. Deine Motive werden nicht auf ONNELLAB-Server hochgeladen."}, {"question": "Welche Dateiformate kann ich exportieren?", "answer": "Du kannst transparente PNG-Dateien und PDF-Dateien mit zusammengeführten Produktionsinhalten exportieren. Die Produktionsebenen der PDF-Datei sind nicht einzeln bearbeitbar. Bearbeitbare Projekte kannst du als Standard-ZIP-Paket übertragen."}, {"question": "Brauche ich Pro für Veredelungsfunktionen?", "answer": "Ja. Zum Vorbereiten und Bearbeiten der unterstützten Veredelungsebenen ist Meriq Pro erforderlich."}, {"question": "Werden bei einem Kauf oder dessen Wiederherstellung Projektinhalte übertragen?", "answer": "Nein. Käufe und deren Wiederherstellung werden vom App Store oder von Google Play verarbeitet. Dabei werden keine Projektinhalte hochgeladen."}, {"question": "Werden Dateien automatisch exportiert oder geteilt?", "answer": "Nein. Export, Teilen und die Übertragung von ZIP-Projektpaketen starten nur auf deine Anweisung."}]),
    quivra: make('Medienkonverter', `Quivra ist ein werbefreier Einmalkauf-Medienkonverter für WAV, M4A, MP4 und MOV mit festen Regeln.\n\nNach der Dateiauswahl bestimmt das Eingabeformat automatisch die passende Konvertierung. Ein Ausgabeformat muss vorher nicht gewählt werden.\n\n## Unterstützte Konvertierungen\n\n- WAV zu MP3\n- M4A zu MP3\n- MP3-Audio aus MP4 extrahieren\n- MOV zu MP4-Video\n\nDer gewählte Ausgabeordner wird gemerkt und Namenskonflikte werden automatisch behandelt. Die Originaldatei bleibt unverändert; das Ergebnis wird als neue Datei erstellt.`, 'Häufige Fragen', [{ question: 'Muss ich ein Ausgabeformat wählen?', answer: 'Nein. Die Konvertierung wird aus dem Eingabeformat abgeleitet.' }, { question: 'Welche Konvertierungen werden unterstützt?', answer: 'WAV und M4A zu MP3, MP4-Audio zu MP3 und MOV zu MP4-Video.' }, { question: 'Wird die Originaldatei verändert?', answer: 'Nein. Das Original bleibt erhalten.' }]),
...
- Buchprojekte und erzeugte EPUB-Dateien werden nicht auf ONNELLAB-Server hochgeladen`, 'Häufige Fragen', [
  ...
  fr: {
    ...
    meriq: make("Créez vos stickers et porte-clés", "Meriq vous aide à préparer les fichiers d’impression de vos autocollants, porte-clés en acrylique et cartes photo. Choisissez les dimensions recommandées pour le produit ou saisissez le format fini souhaité, puis placez votre visuel au recto ou au verso dans un même projet.\n\n## Vérifiez le détourage avant de le valider\n\nPour les projets de porte-clés en acrylique transparent et d’autocollants découpés à la forme, Meriq propose un détourage sur votre appareil lorsque l’image opaque remplit les conditions. Vérifiez le résultat, appliquez-le, ajustez la sélection ou conservez l’image d’origine.\n\n## Découpe, encre blanche et export dans un même projet\n\n- Choisir les dimensions recommandées par produit ou définir un format fini personnalisé\n- Placer des images au recto et au verso et modifier les calques de production\n- Préparer des tracés de découpe vectoriels et une couche d’encre blanche sous le visuel\n- Préparer et modifier les calques de finition pris en charge ; les fonctions de finition nécessitent Meriq Pro\n- Vérifier les dimensions réelles et la résolution de l’image grâce à un contrôle de production de base\n- Exporter un PNG transparent ou un PDF regroupant les éléments de production\n- Transférer des projets modifiables dans des archives ZIP standard\n\n## Vérifiez les consignes de votre imprimeur avant l’envoi\n\nLe PDF regroupe les éléments de production et ne conserve pas de calques de production modifiables séparément. Avant l’envoi, vérifiez les formats de fichier et les dimensions exigés par votre imprimeur.\n\n## Vos créations restent sur votre appareil\n\nLes projets et les images importées sont stockés sur votre appareil. Les aperçus et les exports y sont aussi traités. Aucun compte ni connexion ne sont nécessaires, et il n’y a ni publicité ni synchronisation cloud. Vous choisissez les fichiers à importer. L’exportation, le partage et le transfert de projets ne démarrent qu’à votre demande. Le contenu des images et des projets n’est pas écrit dans les journaux de diagnostic.", "Questions fréquentes", [{"question": "Meriq envoie-t-il mes projets ou images à un serveur ?", "answer": "Non. Les projets et les images importées restent sur votre appareil. Les aperçus et les exports sont traités localement. Vos créations ne sont pas envoyées aux serveurs ONNELLAB."}, {"question": "Quels formats de fichier puis-je exporter ?", "answer": "Vous pouvez exporter un PNG transparent ou un PDF regroupant les éléments de production. Les calques de production du PDF ne sont pas modifiables séparément. Pour transférer un projet modifiable, utilisez une archive ZIP standard."}, {"question": "Les fonctions de finition nécessitent-elles Pro ?", "answer": "Oui. La préparation et la modification des calques de finition pris en charge nécessitent Meriq Pro."}, {"question": "Un achat ou sa restauration transmet-il le contenu du projet ?", "answer": "Non. Les achats et leurs restaurations sont traités par l’App Store ou Google Play. Le contenu du projet n’est pas envoyé pendant cette opération."}, {"question": "Le partage ou l’exportation se lance-t-il automatiquement ?", "answer": "Non. L’exportation, le partage et le transfert d’un projet en ZIP ne démarrent qu’à votre demande."}]),
    quivra: make('Convertisseur multimédia', `Quivra est un convertisseur multimédia à achat unique pour WAV, M4A, MP4 et MOV, sans publicité ni abonnement.\n\nAprès sélection d’un fichier, le format d’entrée détermine automatiquement la conversion. Aucun format de sortie n’est à configurer avant de commencer.\n\n## Conversions prises en charge\n\n- WAV vers MP3\n- M4A vers MP3\n- Extraire l’audio MP3 d’un MP4\n- MOV vers vidéo MP4\n\nLe dossier de sortie choisi est mémorisé et les conflits de nom sont gérés automatiquement. L’original reste intact et un nouveau fichier est créé.`, 'Questions fréquentes', [{ question: 'Dois-je choisir le format de sortie ?', answer: 'Non. La conversion est déterminée par le format d’entrée.' }, { question: 'Quelles conversions sont disponibles ?', answer: 'WAV/M4A vers MP3, extraction audio MP4 vers MP3 et MOV vers vidéo MP4.' }, { question: 'Le fichier original est-il modifié ?', answer: 'Non.' }]),
    segra: make('Découper et assembler de l’audio', `Segra simplifie les tâches audio courantes : découper une partie d’un MP3/WAV, assembler plusieurs enregistrements ou créer une vidéo MP4 à partir d’un audio et d’une image.\n\nL’objectif n’est pas la production musicale complète, mais le découpage d’enregistrements longs, l’assemblage dans l’ordre choisi et les vidéos simples pour narration, podcasts, livres audio ou TTS.\n\n## Fonctions principales\n\n- Choisir début et fin d’un extrait\n- Assembler plusieurs fichiers audio\n- Créer un MP4 avec audio et image\n- Préserver les fichiers originaux\n- Tout traiter localement et hors ligne\n\nAucun compte requis, aucun envoi de fichier, aucune publicité ni suivi.`, 'Questions fréquentes', [{ question: 'Le fichier audio original est-il modifié ?', answer: 'Non. Les extraits et assemblages sont enregistrés comme nouveaux fichiers.' }, { question: 'Quelles tâches audio sont prises en charge ?', answer: 'Découpe MP3/WAV, assemblage de fichiers et création MP4 avec audio et image.' }, { question: 'Les fichiers sont-ils envoyés à un serveur ?', answer: 'Non.' }]),
...
- Les projets et EPUB générés ne sont pas envoyés vers un serveur ONNELLAB`, 'Questions fréquentes', [
  ...
  es: {
    ...
    meriq: make("Crea pegatinas y llaveros acrílicos", "Meriq te ayuda a preparar archivos para imprimir pegatinas, llaveros acrílicos y tarjetas fotográficas. Elige las medidas recomendadas para el producto o introduce el tamaño final que necesitas y coloca tu diseño en la cara delantera o trasera, todo en un solo proyecto.\n\n## Revisa el fondo transparente antes de aplicar el resultado\n\nEn los proyectos de llaveros de acrílico transparente y pegatinas troqueladas, Meriq genera en tu dispositivo una propuesta para quitar el fondo de las imágenes opacas que cumplan los criterios. Revisa el resultado, aplícalo, ajusta la selección o conserva la imagen original.\n\n## Prepara el corte, la tinta blanca y la exportación en un proyecto\n\n- Elegir medidas recomendadas por producto o definir un tamaño final personalizado\n- Colocar imágenes y editar las capas de producción de ambas caras\n- Preparar líneas de corte vectoriales y una capa de tinta blanca bajo el diseño\n- Preparar y editar las capas de acabado compatibles; las funciones de acabado requieren Meriq Pro\n- Comprobar las dimensiones reales y la resolución de la imagen con una revisión básica de producción\n- Exportar PNG transparente y PDF con el contenido de producción combinado\n- Transferir proyectos editables en paquetes ZIP estándar\n\n## Confirma los requisitos de tu imprenta antes del envío\n\nEl PDF combina el contenido de producción y no conserva capas de producción editables por separado. Antes de enviarlo a imprimir, confirma los formatos de archivo y las medidas que exige tu imprenta.\n\n## Tus diseños se quedan en tu dispositivo\n\nLos proyectos y las imágenes importadas se guardan en el dispositivo. Las vistas previas y las exportaciones también se procesan localmente. No necesitas una cuenta ni iniciar sesión, y no hay anuncios ni sincronización en la nube. Tú eliges qué archivos importar. La exportación, el uso compartido y la transferencia de proyectos solo empiezan cuando eliges esas acciones. El contenido de imágenes y proyectos no se escribe en los registros de diagnóstico.", "Preguntas frecuentes", [{"question": "¿Meriq sube mis proyectos o imágenes a un servidor?", "answer": "No. Los proyectos y las imágenes importadas se quedan en tu dispositivo. Las vistas previas y las exportaciones se procesan localmente. Tus diseños no se suben a los servidores de ONNELLAB."}, {"question": "¿Qué formatos de archivo puedo exportar?", "answer": "Puedes exportar PNG transparente y PDF con el contenido de producción combinado. Las capas de producción del PDF no se pueden editar por separado. Para transferir un proyecto editable, utiliza un paquete ZIP estándar."}, {"question": "¿Las funciones de acabado requieren Pro?", "answer": "Sí. Preparar y editar las capas de acabado compatibles requiere Meriq Pro."}, {"question": "¿Comprar o restaurar una compra envía el contenido del proyecto?", "answer": "No. App Store o Google Play procesan las compras y sus restauraciones. El contenido del proyecto no se sube durante ese proceso."}, {"question": "¿La exportación o el uso compartido se inicia automáticamente?", "answer": "No. La exportación, el uso compartido y la transferencia de paquetes ZIP de proyecto solo empiezan cuando tú lo decides."}]),
    quivra: make('Conversor multimedia', `Quivra es un conversor multimedia de pago único para WAV, M4A, MP4 y MOV. No tiene anuncios ni suscripción.\n\nAl elegir un archivo, el formato de entrada determina automáticamente la conversión. No necesitas configurar el formato de salida.\n\n## Conversiones compatibles\n\n- WAV a MP3\n- M4A a MP3\n- Extraer audio MP3 de MP4\n- MOV a vídeo MP4\n\nSe recuerda la ubicación de salida y los conflictos de nombre se gestionan automáticamente. El original no se modifica; se crea un archivo nuevo.`, 'Preguntas frecuentes', [{ question: '¿Tengo que elegir el formato de salida?', answer: 'No. Se determina según el formato de entrada.' }, { question: '¿Qué conversiones admite?', answer: 'WAV/M4A a MP3, extracción de audio MP4 a MP3 y MOV a vídeo MP4.' }, { question: '¿Se modifica el original?', answer: 'No.' }]),
