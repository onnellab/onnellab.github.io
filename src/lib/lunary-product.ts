  ...
  "pt-BR": {
    ...
    "faq": [
      ...
      },
      {
        ...
        "answer": "Capas em GIF podem ser animadas dentro do Lunary. No widget da tela inicial, elas aparecem como uma imagem fixa em estilo de pôster para manter o mês legível e leve."
      }
    ]
  },
  "de": {
    "subtitle": "Ein Monatskalender, mit dem jeder Monat sein eigenes gestaltetes Cover bekommt.",
    "body": "Lunary ist ein Monatskalender, bei dem Erinnerungen und die Stimmung eines Monats wichtiger sind als möglichst viele Produktivitätsfunktionen.\n\nHalte Termine in einer ruhigen Monatsansicht fest und gestalte für jeden Monat ein eigenes Cover mit Hintergrund und Stickern. Den fertig gestalteten Monat kannst du außerdem als Poster-Widget auf dem Home-Bildschirm anzeigen. Die Verbindung mit Google Kalender ist optional. Der lokale Kalender und die Cover-Funktionen von Lunary funktionieren offline und ohne Anmeldung. Wenn du Google Kalender verbinden möchtest, wählst du den bearbeitbaren Kalender aus und kannst Termine in beide Richtungen synchronisieren.\n\n## Hauptfunktionen\n\n- Monatskalender, bei dem der Monat im Mittelpunkt steht\n- Lokale Termine ohne Anmeldung erstellen, bearbeiten und löschen\n- Für jeden Monat ein separat gespeichertes Cover mit Hintergrund und Stickern\n- Position, Größe, Drehung und Ebenenreihenfolge von Stickern bearbeiten\n- Optionale Verbindung mit Google Kalender und bidirektionale Terminsynchronisierung\n- Poster-Widget für den Home-Bildschirm mit Cover, Monatskalender und Terminmarkierungen\n- Animierte GIF-Cover in der App und ein stabiles Standbild im Widget\n- Oberfläche auf Englisch, Koreanisch, Japanisch, vereinfachtem und traditionellem Chinesisch, brasilianischem Portugiesisch, Deutsch, Französisch und Spanisch\n\nGoogle Kalender wird nur aktiviert, wenn du ihn ausdrücklich verbindest. Lokale Termine und Monatscover bleiben auch ohne Google-Verbindung verfügbar.",
