...
const copy: Record<ReleaseLocale, Record<string, ReleaseCopy>> = {
  ja: {
    'tagweaver/2.3': { summary: 'iOS と Android の審査に提出した TagWeaver 2.3 共通のリリースノートです。', changes: ['FLACファイルのカバー画像が保存されないことがある問題を修正しました。','軽微な不具合を修正し、7言語を追加して、対応言語は合計9言語になりました。'] },
  ...
  'zh-Hans': {
    'tagweaver/2.3': { summary: '这是已提交 iOS 和 Android 审核的 TagWeaver 2.3 共用版本说明。', changes: ['修复了 FLAC 文件的封面图片有时无法保存的问题。','修复了若干小问题，并新增 7 种语言，目前共支持 9 种语言。'] },
  ...
  'zh-Hant': {
    'tagweaver/2.3': { summary: '這是已提交 iOS 與 Android 審核的 TagWeaver 2.3 共用版本說明。', changes: ['修正 FLAC 檔案的封面圖片有時無法儲存的問題。','修正一些小問題，並新增 7 種語言，目前共支援 9 種語言。'] },
  ...
  'pt-BR': {
    'tagweaver/2.3': { summary: 'Notas da versão do TagWeaver 2.3 para iOS e Android. A atualização está em análise nas lojas.', changes: ['Corrigimos um problema que podia impedir o salvamento da capa em arquivos FLAC.','Corrigimos pequenos problemas e adicionamos 7 idiomas, totalizando 9 idiomas compatíveis.'] },
  ...
  de: {
    'tagweaver/2.3': { summary: 'Gemeinsame Versionshinweise zu TagWeaver 2.3 für iOS und Android. Das Update wurde zur Prüfung eingereicht.', changes: ['Ein Problem wurde behoben, durch das Coverbilder in FLAC-Dateien möglicherweise nicht gespeichert wurden.','Kleinere Fehler wurden behoben und 7 Sprachen hinzugefügt. Damit werden insgesamt 9 Sprachen unterstützt.'] },
  ...
  fr: {
    'tagweaver/2.3': { summary: 'Notes de version communes de TagWeaver 2.3 pour iOS et Android. La mise à jour a été soumise à validation.', changes: ['Correction d’un problème pouvant empêcher l’enregistrement des pochettes dans les fichiers FLAC.','Correction de problèmes mineurs et ajout de 7 langues, pour un total de 9 langues prises en charge.'] },
  ...
  es: {
    'tagweaver/2.3': { summary: 'Notas de la versión de TagWeaver 2.3 para iOS y Android. La actualización está en revisión.', changes: ['Corregimos un problema que podía impedir que se guardaran las carátulas en archivos FLAC.','Corregimos problemas menores y añadimos 7 idiomas, para un total de 9 idiomas compatibles.'] },
